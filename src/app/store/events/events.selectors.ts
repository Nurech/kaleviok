...
import { EventVM, Event } from './events.model';
...
export const selectCurrentEvent = createSelector(selectCurrentEventId, selectEventEntities, (eventId, entities) => entities[eventId] || ({} as Event));
