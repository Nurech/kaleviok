...
export const updateSettings = createAction('[Settings] Change Settings', props<{ changes: Partial<Setting> }>());
export const updateSettingsSuccess = createAction('[Settings] Change Success', props<{ changes: Partial<Setting> }>());
